...
注意：为了方便使用，命令行工具的名称为 `rp`，您需要使用 `rp` 来执行相关命令。
...
```bash
rp -m "这是一条视频链接: https://youtu.be/xgXFCOoQJVc"
```
...
```bash
rp iu_folder/ -m "嗨! 这些是今天的 IU 报告" -c iu_wiki.md -p 1993
```
